...
{
    public class S7VariableDIntArray : S7VariableArray<S7VariableDInt, Int32>
    {
        public S7VariableDIntArray(Int32[] value) : base(value) { }
        public S7VariableDIntArray(Int32[] value, byte flags) : base(value, flags) { }
        public static S7VariableDIntArray Deserialize(Stream buffer, byte flags, bool disableVlq)
        {
            var baseArray = DeserializeBase(buffer, flags, disableVlq);
            return new S7VariableDIntArray(baseArray.Value);
        }
    }
