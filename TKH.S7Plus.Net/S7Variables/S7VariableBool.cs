...
{
    public class S7VariableBoolArray : S7VariableArray<S7VariableBool, bool>
    {
    ...
    public class S7VariableBool : S7VariableBase
    {
        ...
        public S7VariableBool() : this(default, 0)
        {
        }

        public S7VariableBool(bool value) : this(value, 0)
        {
        }

        public S7VariableBool(bool value, byte flags)
        {
            Datatype = Constants.Datatype.Bool;
        ...
        public override int Serialize(Stream buffer)
        {
            ...
            length += S7ValueEncoder.EncodeByte(buffer, Convert.ToByte(Value));
            return length;
        }

        public static S7VariableBool Deserialize(Stream buffer, byte flags)
        {
            byte value = S7ValueDecoder.DecodeByte(buffer);
            return new S7VariableBool(Convert.ToBoolean(value), flags);
        }
    }
}