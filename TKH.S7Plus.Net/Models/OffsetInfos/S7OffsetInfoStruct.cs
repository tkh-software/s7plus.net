...
{
    public class S7OffsetInfoStruct : S7OffsetInfo, IOffsetInfo, IOffsetInfoRelation
    {
        ...
        public static S7OffsetInfoStruct Deserialize(Stream buffer)
        {
            S7OffsetInfoStruct result = new S7OffsetInfoStruct();
