...
{
    public class S7OffsetInfoStructMDim : S7OffsetInfo, IOffsetInfo1Dim, IOffsetInfoRelation
    {
        ...
        public static S7OffsetInfoStructMDim Deserialize(Stream buffer)
        {
            S7OffsetInfoStructMDim result = new S7OffsetInfoStructMDim();
