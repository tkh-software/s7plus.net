...
{
    public class S7OffsetInfoArray1Dim : S7OffsetInfo, IOffsetInfo1Dim
    {
        ...
        public static S7OffsetInfoArray1Dim Deserialize(Stream buffer)
        {
            S7OffsetInfoArray1Dim result = new S7OffsetInfoArray1Dim();
