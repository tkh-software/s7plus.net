...
namespace TKH.S7Plus.Net.Constants
{
    public static class S7Ids
    {
        ...
        public const int ServerSessionClientID = 289;
        ...
        public const int ServerSessionClientComment = 301;
        public const int ServerSessionChallenge = 303;
        public const int ServerSessionVersion = 306;
        public const int SessionVersionSystemOMS = 315;
        public const int SessionVersionProjectOMS = 316;
        public const int SessionVersionSystemPAOM = 317;
        public const int SessionVersionProjectPAOM = 318;
        public const int SessionVersionSystemPAOMString = 319;
        public const int SessionVersionProjectPAOMString = 320;
        ...
        public const int SecurityKeyPublicKey = 1803;
        public const int SecurityKeySymmetricKey = 1804;
        public const int SecurityKeyEncryptedKey = 1805;
        public const int SecurityKeyId = 1825;
        public const int ID = 1826;
        public const int Flags = 1827;
        public const int FlagsInternal = 1828;
        public const int SessionKey = 1830;
