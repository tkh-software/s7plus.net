...
namespace S7Plus.Net.Helpers
{
    public static class ConvertGeneric
    {
        private static readonly Dictionary<Type, Delegate> _serializers = new()
        {
            ...
            { typeof(UInt32), new Func<Stream, UInt32, int>(S7VlqValueEncoder.EncodeUInt32Vlq) },
            { typeof(Int32), new Func<Stream, Int32, int>(S7VlqValueEncoder.EncodeInt32Vlq) },
            { typeof(UInt64), new Func<Stream, UInt64, int>(S7VlqValueEncoder.EncodeUInt64Vlq) },
            { typeof(Int64), new Func<Stream, Int64, int>(S7VlqValueEncoder.EncodeInt64Vlq) },
